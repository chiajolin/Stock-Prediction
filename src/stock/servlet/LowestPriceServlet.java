 ...
 */
@WebServlet("/LowestPriceServlet")
public class LowestPriceServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public LowestPriceServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {  
        	...
        	String sql = "SELECT D.Stock_Id, D.Name, MIN(D.Close) AS Price "+
        				 "FROM ( "+
            ...
            String output = "<tr><td>Stock ID</td><td>Stock Symbol</td><td>Lowest Price</td></tr>";
            while(result.next())
            {
